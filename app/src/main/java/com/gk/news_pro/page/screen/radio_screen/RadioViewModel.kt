...
class RadioViewModel(
    ...
    fun fetchFavoriteStations() {
        viewModelScope.launch {
            try {
                val stations = userService.getFavoriteRadioStations()
    ...
    fun toggleFavoriteStation(station: RadioStation, isFavorited: Boolean) {
        viewModelScope.launch {
            try {
                if (isFavorited) {
                    userService.addFavoriteRadioStation(station.stationuuid)
                    ...
                    userService.removeFavoriteRadioStation(station.stationuuid)
...
//    private val radioApiService = RetrofitClient.createService(RadioApiService::class.java)
//
//    fun fetchStationsByCountry(country: String) {
//        viewModelScope.launch {
//            try {
//                _radioStations.value = radioApiService.getStationsByCountry(country)
...
//    }
//
//    fun searchStations(name: String, country: String = "", tag: String = "") {
//        viewModelScope.launch {
//            try {
//                _radioStations.value = radioApiService.searchStations(name, country, tag)
//            } catch (e: HttpException) {
//                _radioStations.value = emptyList()
//            } catch (e: Exception) {
//                _radioStations.value = emptyList()
